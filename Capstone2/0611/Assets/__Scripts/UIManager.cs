...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject priceNotice;
    ...
    void Start()
    {
        ...
        priceNotice = Canvas.transform.Find("PriceNotice").gameObject;
        ...
        UI_Store = Canvas.transform.Find("Store").gameObject;
    ...
    public Text SetPriceAnchor(Text text)
    {
        var tGO = text;
        if (tGO != null)
        {
            tGO.transform.SetParent(UI_Store.transform.GetChild(2));
        }
        return tGO;
    }

    public void EnablePriceNotice()
    {
        priceNotice.SetActive(true);
        Invoke("DisablePriceNotice", 1f);
    }

    public void DisablePriceNotice()
    {
        priceNotice.SetActive(false);
    }
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        {
            StoreManager.instance.ClearStorePrice();
            SetFalse_All();
            SetUpStateBar();
            SetTure_upStateBar();
        }
